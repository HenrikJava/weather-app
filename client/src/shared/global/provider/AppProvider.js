...
export const UserProvider = (props) =>{
    ...
    return(
        <UserContext.Provider value={[authenticatedUser, setAuthenticatedUser,firstname,
            setFirstname,
            lastname,
        setLastname,username, setUsername,password, setPassword, mail, setMail,favoriteCity, setFavoriteCity,celciusOn, setcelciusOn]}>
            {props.children}
