      ...
      <Grid item xs={12} className="suns-inner-wrapper">
        <Grid item xs={6}>
          ...
          <p>
            ...
            {app.swedish ? calcTime(weather.weather.city.timezone, weather.weather.city.sunrise)
              .toTimeString()
              .slice(0, 5) : calcTime(weather.weather.city.timezone, weather.weather.city.sunrise)
        ...
        <Grid item xs={6}>
          ...
          <p>
            {app.swedish ? calcTime(weather.weather.city.timezone, weather.weather.city.sunset)
              .toTimeString()
              .slice(0, 5) : calcTime(weather.weather.city.timezone, weather.weather.city.sunset)
              .toLocaleString('en-US', { hour: 'numeric',minute: 'numeric', hour12: true })
              }
          </p>
        </Grid>
