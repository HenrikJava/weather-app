    ...
    <div className="footer-wrapper">
      <div className="footer-item">
        ...
        <Link
          ...
          href="mailto:henriklarssonmail@gmail.com"
          target="_blank"
        >
          Contact
        </Link>
      ...
      <div className="footer-item">
        ...
        <Link
          id="footer-label-github"
          href="https://github.com/HenrikJava"
          target="_blank"
        >
          Github
        </Link>
      ...
      <div className="footer-item">
        ...
        <Link
          id="footer-label-facebook"
          href="https://www.facebook.com/HenrikLarsson1978"
          target="_blank"
        >
          Facebook
        </Link>
