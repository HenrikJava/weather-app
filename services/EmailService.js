...
const sendResetEmail = (token, email, swedish) => {
  ...
  let subject
  swedish
    ? text = "Du får detta milet för att du(eller någon annan) har önskat att återställa ditt lösenord på ditt konto. \n" +
    ...
    swedish ? subject = 'Återställande av lösenord' : subject = "Link to reset password"  
  const mailOptions = {
